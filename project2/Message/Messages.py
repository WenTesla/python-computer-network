...
class Message():  # 处理消息的格式，状态消息
    ...
    def ChatMessage(self):
        self.MessageStr = self.way + '\t' + gettime() + '\t' + self.value
        return self.MessageStr
    ...
    def IsOperationMessage(self):  # 请补充
        return self.way in self._Operation  # 对比  in 是对比

    def IsChatMessage(self):  # 请补充
        return self.way in self._Chat  # 对比  in 是对比

    def IsFilerequest(self):  # 请补充
        return self.way in self._File  # 对比  in 是对比
